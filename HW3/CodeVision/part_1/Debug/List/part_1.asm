...
_0x3:
	.DB  0x46,0x61,0x7A,0x65,0x6C,0x0,0xD,0xA
	.DB  0x39,0x38,0x32,0x35,0x35,0x38,0x33,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0022 char std_number[] = "\r\n9825583";
; 0000 0023 char last_name[] = "Fazel";
...
; 0000 0048 lcd_init(16);
	LDI  R26,LOW(16)
	RCALL _lcd_init
; 0000 0049 lcd_puts(last_name);
	MOVW R26,R28
	RCALL _lcd_puts
; 0000 004A 
; 0000 004B lcd_puts(std_number);
	MOVW R26,R28
	ADIW R26,6
	RCALL _lcd_puts
; 0000 004C while (1)

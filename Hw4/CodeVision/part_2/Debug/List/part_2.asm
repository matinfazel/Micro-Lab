...
_0x40000:
	.DB  0x25,0x73,0x0,0x43,0x45,0x3A,0x46,0x55
	.DB  0x4C,0x4C,0x0,0xA,0x43,0x45,0x3A,0x25
	.DB  0x64,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0002 0007     if (PINB.7 ==0 )
	...
	RJMP _0x40003
; 0002 0008         total_car++;
	LDI  R26,LOW(_total_car)
	LDI  R27,HIGH(_total_car)
	LD   R30,X+
	LD   R31,X+
	ADIW R30,1
	RJMP _0x4000A

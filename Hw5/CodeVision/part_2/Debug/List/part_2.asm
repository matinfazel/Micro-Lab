...
; 0000 0024 lcd_init(8);
	LDI  R26,LOW(8)
	CALL _lcd_init
; 0000 0025 init_timers_ports();
	RCALL _init_timers_ports
; 0000 0026 func2();
	CALL _func2
; 0000 0027 
; 0000 0028 
...
;#include <math.h>
;#include <mega16.h>
;void init_timers_ports(void){
; 0001 0004 void init_timers_ports(void){

	.CSEG
_init_timers_ports:
; .FSTART _init_timers_ports
...
; 0001 000E DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (1<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	LDI  R30,LOW(8)
	OUT  0x17,R30
...
; 0001 001F // Clock value: 7.813 kHz
; 0001 0020 // Mode: Phase correct PWM top=0xFF
; 0001 0021 // OC0 output: Non-Inverted PWM
; 0001 0022 // Timer Period: 65.28 ms
; 0001 0023 // Output Pulse(s):
; 0001 0024 // OC0 Period: 65.28 ms Width: 3.328 ms
; 0001 0025 TCCR0=(1<<WGM00) | (1<<COM01) | (0<<COM00) | (0<<WGM01) | (1<<CS02) | (0<<CS01) | (1<<CS00);
	LDI  R30,LOW(101)
	OUT  0x33,R30
...
; 0001 0033 OCR1BL=0x00;
	OUT  0x28,R30
; 0001 0034 
; 0001 0035 ASSR=0<<AS2;
	OUT  0x22,R30
; 0001 0036 TCCR2=(0<<PWM2) | (0<<COM21) | (0<<COM20) | (0<<CTC2) | (0<<CS22) | (0<<CS21) | (0<<CS20);
	OUT  0x25,R30
; 0001 0037 TCNT2=0x00;
	OUT  0x24,R30
; 0001 0038 OCR2=0x00;
	OUT  0x23,R30
; 0001 0039 
; 0001 003A // Timer(s)/Counter(s) Interrupt(s) initialization
; 0001 003B TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<OCIE0) | (0<<TOIE0);
	OUT  0x39,R30
; 0001 003C 
; 0001 003D 
...
; 0001 003F MCUCSR=(0<<ISC2);
	OUT  0x34,R30
; 0001 0040 
; 0001 0041 // USART initialization
; 0001 0042 // USART disabled
; 0001 0043 UCSRB=(0<<RXCIE) | (0<<TXCIE) | (0<<UDRIE) | (0<<RXEN) | (0<<TXEN) | (0<<UCSZ2) | (0<<RXB8) | (0<<TXB8);
	OUT  0xA,R30
; 0001 0044 
; 0001 0045 // Analog Comparator initialization
; 0001 0046 // Analog Comparator: Off
; 0001 0047 // The Analog Comparator's positive input is
; 0001 0048 // connected to the AIN0 pin
; 0001 0049 // The Analog Comparator's negative input is
; 0001 004A // connected to the AIN1 pin
; 0001 004B ACSR=(1<<ACD) | (0<<ACBG) | (0<<ACO) | (0<<ACI) | (0<<ACIE) | (0<<ACIC) | (0<<ACIS1) | (0<<ACIS0);
	LDI  R30,LOW(128)
	OUT  0x8,R30
; 0001 004C SFIOR=(0<<ACME);
	LDI  R30,LOW(0)
	OUT  0x30,R30
; 0001 004D 
; 0001 004E // ADC initialization
; 0001 004F // ADC disabled
; 0001 0050 ADCSRA=(0<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (0<<ADPS1) | (0<<ADPS0);
	OUT  0x6,R30
; 0001 0051 
; 0001 0052 // SPI initialization
; 0001 0053 // SPI disabled
; 0001 0054 SPCR=(0<<SPIE) | (0<<SPE) | (0<<DORD) | (0<<MSTR) | (0<<CPOL) | (0<<CPHA) | (0<<SPR1) | (0<<SPR0);
	OUT  0xD,R30
; 0001 0055 
; 0001 0056 // TWI initialization
; 0001 0057 // TWI disabled
; 0001 0058 TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	OUT  0x36,R30
; 0001 0059 
; 0001 005A }
	RET
...
;#include <mega16.h>
;void func2(){
; 0002 0004 void func2(){

	.CSEG
_func2:
; .FSTART _func2
; 0002 0005 
; 0002 0006     int duty_cycle = 0;
; 0002 0007     DDRA = 0x00;
	ST   -Y,R17
	ST   -Y,R16
;	duty_cycle -> R16,R17
	...
	LDI  R30,LOW(0)
	OUT  0x1A,R30
; 0002 0008     duty_cycle = 45;
	__GETWRN 16,17,45
; 0002 0009     duty_cycle = ((duty_cycle*90)/255) + 5;
	MOVW R30,R16
	LDI  R26,LOW(90)
	LDI  R27,HIGH(90)
	CALL __MULW12
	...
	ADIW R30,5
	MOVW R16,R30
; 0002 000A     duty_cycle = floor((duty_cycle*255)/100);
	LDI  R26,LOW(255)
	LDI  R27,HIGH(255)
	CALL __MULW12
	MOVW R26,R30

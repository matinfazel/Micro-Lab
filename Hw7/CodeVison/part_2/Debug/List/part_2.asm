...
_0x0:
	.DB  0x54,0x78,0x3A,0x25,0x63,0xD,0xA,0x0
	.DB  0x52,0x78,0x3A,0x20,0x44,0x61,0x74,0x61
	.DB  0x20,0x69,0x73,0x20,0x61,0x20,0x69,0x6E
	.DB  0x74,0x65,0x67,0x65,0x72,0x20,0x61,0x6E
	.DB  0x64,0x20,0x31,0x30,0x20,0x2A,0x20,0x25
	.DB  0x63,0x3D,0x25,0x63,0x30,0xA,0xD,0x0
	.DB  0x4C,0x43,0x44,0x20,0x44,0x65,0x6C,0x65
	.DB  0x74,0x65,0x64,0x21,0xA,0xD,0x0,0x2A
	.DB  0x2A,0x2A,0x2A,0x2A,0x2A,0x2A,0x2A,0xD
	.DB  0xA,0x4D,0x69,0x63,0x72,0x6F,0x20,0x50
	.DB  0x72,0x6F,0x63,0x65,0x73,0x73,0x6F,0x72
	.DB  0x20,0x4C,0x61,0x62,0x20,0x49,0x55,0x54
	.DB  0x20,0x2A,0x2A,0x2A,0x2A,0x2A,0x2A,0x2A
	.DB  0x2A,0xA,0xD,0x0,0x52,0x78,0x3A,0x20
	.DB  0x45,0x6E,0x64,0x20,0x6F,0x66,0x20,0x74
	.DB  0x68,0x65,0x20,0x70,0x61,0x72,0x74,0xD
	.DB  0xA,0x0,0x54,0x78,0x3A,0x20,0x25,0x63
	.DB  0xA,0xD,0x0,0x52,0x78,0x3A,0x20,0x69
...
; 0000 00BD UCSRA=(0<<RXC) | (0<<TXC) | (0<<UDRE) | (0<<FE) | (0<<DOR) | (0<<UPE) | (0<<U2X) | (0<<MPCM);
	OUT  0xB,R30
; 0000 00BE UCSRB=(1<<RXCIE) | (1<<TXCIE) | (0<<UDRIE) | (1<<RXEN) | (1<<TXEN) | (0<<UCSZ2) | (0<<RXB8) | (0<<TXB8);
	LDI  R30,LOW(216)
	OUT  0xA,R30
...
_0x14:
; 0000 00D4       {
; 0000 00D5      data = getchar();
	RCALL _getchar
	MOV  R17,R30
; 0000 00D6      func2(data);
	MOV  R26,R17
	RCALL _func2
; 0000 00D7 
; 0000 00D8 
...
;
;void func2(char data){
; 0000 00DC void func2(char data){
_func2:
; .FSTART _func2
; 0000 00DD 
; 0000 00DE            if (data >= '0' && data<='9'){
	ST   -Y,R26
;	data -> Y+0
	LD   R26,Y
	CPI  R26,LOW(0x30)
...
_0x19:
	RJMP _0x18
_0x1A:
; 0000 00DF         printf("Tx:%c\r\n",data);
	__POINTW1FN _0x0,0
	CALL SUBOPT_0x0
	CALL SUBOPT_0x1
; 0000 00E0         printf("Rx: Data is a integer and 10 * %c=%c0\n\r", data,data);
	__POINTW1FN _0x0,8
	CALL SUBOPT_0x0
	LDD  R30,Y+6
	CLR  R31
...
; 0000 00E3           lcd_clear();
	RCALL _lcd_clear
; 0000 00E4           lcd_puts("LCD Deleted!\n\r");
	__POINTW2MN _0x1D,0
	RCALL _lcd_puts
; 0000 00E5           }
; 0000 00E6      else if (data == 'H')
	RJMP _0x1E
_0x1C:
	LD   R26,Y
	CPI  R26,LOW(0x48)
...
; 0000 00E7         printf("********\r\nMicro Processor Lab IUT ********\n\r");
	__POINTW1FN _0x0,63
	CALL SUBOPT_0x2
; 0000 00E8      else if (data == 'E'){
	RJMP _0x20
_0x1F:
	LD   R26,Y
	CPI  R26,LOW(0x45)
	BRNE _0x21
; 0000 00E9         printf("Rx: End of the part\r\n");
...
; 0000 00EC      else {
	RJMP _0x22
_0x21:
; 0000 00ED         printf("Tx: %c\n\r",data);
	__POINTW1FN _0x0,130
	CALL SUBOPT_0x0
	CALL SUBOPT_0x1
; 0000 00EE         printf("Rx: input letter is %c\n\r",data);

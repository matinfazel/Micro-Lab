...
_0x0:
	...
	.DB  0x75,0x72,0x20,0x66,0x75,0x6C,0x6C,0x20
	.DB  0x6E,0x61,0x6D,0x65,0xA,0xD,0x0,0x25
	.DB  0x73,0x0,0x3C,0x3C,0x25,0x73,0x20,0x25
	.DB  0x73,0x3E,0x3E,0xA,0xD,0x0
__RESET:
	CLI
	CLR  R30
	OUT  EECR,R30
...
;
;void main(void)
; 0000 0020 {   char first_name[30];

	.CSEG
_main:
; .FSTART _main
; 0000 0021     char last_name[30];
...
; 0000 0043 UCSRA=(0<<RXC) | (0<<TXC) | (0<<UDRE) | (0<<FE) | (0<<DOR) | (0<<UPE) | (0<<U2X) | (0<<MPCM);
	OUT  0xB,R30
; 0000 0044 UCSRB=(0<<RXCIE) | (0<<TXCIE) | (0<<UDRIE) | (1<<RXEN) | (1<<TXEN) | (0<<UCSZ2) | (0<<RXB8) | (0<<TXB8);
	LDI  R30,LOW(24)
	OUT  0xA,R30
...
; 0000 004C       printf("Enter your full name\n\r");
	__POINTW1FN _0x0,0
	ST   -Y,R31
	ST   -Y,R30
	LDI  R24,0
	CALL _printf
	ADIW R28,2
; 0000 004D       scanf("%s",first_name);
	__POINTW1FN _0x0,23
	CALL SUBOPT_0x0
	LDI  R24,4
	CALL _scanf
	ADIW R28,6
; 0000 004E       scanf("%s",last_name);
	__POINTW1FN _0x0,23
	ST   -Y,R31
	ST   -Y,R30
	MOVW R30,R28

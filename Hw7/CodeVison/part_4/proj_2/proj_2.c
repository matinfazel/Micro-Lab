...
void func2(char data){
           ...
           if (data >= '0' && data<='9'){
        printf("Tx:%c\r\n",data);
        printf("Rx: Data is a integer and 10 * %c=%c0\n\r", data,data);    
        }
     else if (data == 'D'){ 
          lcd_clear();
        ...
        printf("Rx: End of the part\r\n"); 
       #asm("cli");
        }
     else {
        printf("Tx: %c\n\r",data);
        printf("Rx: input letter is %c\n\r",data);
        }
...
void func3(){
      ...
      if (tmp == 0 && a == ')'){
            if (count == 5 && !include_w){ 
                lcd_puts("The frame is correct\r\n");                 
                }
            else if (include_w)
                 lcd_puts("The frame must be 5 integer\r\n");
            else 
